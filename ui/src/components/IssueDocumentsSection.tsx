                ...
                actionsSlot={
                  <>
                    ...
                    >
                      ...
                      <span title="锁定文档" aria-label="锁定文档" className="inline-flex h-6 w-6 items-center justify-center text-amber-700 dark:text-amber-300">
                ...
                >
                  ...
                  {activeConflict && !isHistoricalPreview && (
                    <div className="rounded-md border border-amber-500/30 bg-amber-500/5 px-3 py-3">
                      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                        <div className="space-y-1">
                          <p className="text-sm font-medium text-amber-800 dark:text-amber-200">已过期</p>
                          <p className="text-xs text-muted-foreground">
